...
class EB{
	...
	private function define_public_hooks(){
		...
		$this->loader->add_filter('wp_mail', $plugin_public, 'mail_filter', 9);
	}
	...
	private function create_master_settings(){
		...
		$setting_page = new EB_Settings('Email Beautify');
	...
	private function load_dependencies(){
		...
		require_once plugin_dir_path(dirname(__FILE__)).'public/EB_EmailMaker.php';
